...
RSpec.describe ArtistsController, type: :controller do
  describe "GET #index" do
    it "assigns all artist as @artists and renders the index template" do
  ...
  describe "GET #new" do
    it "assigns the requested artist as @artist and renders the new template" do
      get(:new)
  ...
  describe "GET #edit" do
    it "assigns the requested artist as @artists and renders the edit template" do
      artist = create(:artist)
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns newley created artist as @artist" do
        post :create, {:artist => attributes_for(:artist)}
    ...
    context "with invalid params" do
      it "assigns a newly created but unsved artist as @artist" do
  ...
  describe "DELETE #destroy" do
    it "destroys the selected artists" do
      artist = create(:artist)
      expect {
    ...
    it "renders the artists page" do
      artist = create(:artist)
      delete :destroy, {:id => artist.to_param}
